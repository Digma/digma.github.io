...
In this article, we will reproduce using **Matplotlib** a [Line Chart of Global Greenhouse Gas Emissions by Sector](https://ourworldindata.org/grapher/ghg-emissions-by-sector):
...
While the result is not exact, we did get pretty close:
