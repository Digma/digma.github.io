...
Following the launch of the GPT Store, I have been exploring the potential of GPTs. I am happy to share that I am releasing my first GPT called [Dataviz Mentor](https://chat.openai.com/g/g-rk1495Cu2-dataviz-mentor). It is now available for free to all ChatGPT Plus subscribers who want to improve their data visualizations.

## Enhance your Presentations and Data Visualizations with DataViz Mentor

Creating quality data visualizations often requires significant time and expertise. DataViz Mentor aims to simplify this process. It acts as an assistant or "mentor," offering immediate feedback on your visualizations. It guides you with prioritized improvements that can be made to any data visualization or plot.

To use it, go to the [ChatGPT interface](https://chat.openai.com/g/g-rk1495Cu2-dataviz-mentor) and follow these steps:
...
Using GPT4-turbo and its language and vision abilities, the system is then able to combine its knowledge with the uploaded image to provide guided recommendations. 

I will share more about creating and publishing such a GPT in a future blog post (Stay tuned 😊)

## Real-world Examples

To evaluate the system, let's see if it aligns with some of The Economist's suggestions. In a [Medium blog post](https://medium.economist.com/mistakes-weve-drawn-a-few-8cdd8a42d368), journalist Sarah Leo from The Economist discusses some past mistakes they've made. They showcase the initial visualization and the improved version. Let's see if DataViz Mentor agrees with their recommendations.

### Example 1: Recommending splitting the chart into 2

Here's the first example from The Economist:
...
Here are DataViz Mentor's recommendations for the first (left) plot:
...
Here's another example from The Economist, this time looking at the correlation between 2 variables:
...
While the initial version is already very helpful, the system is the first iteration and is not (yet) perfect. Some of the improvements I am planning to work on are:

- **Helping you implement the recommended changes in your data visualization software or framework**: Assisting you in easily modifying your original plot is very important. This is a key challenge given the variety of tools available today, but an important one to tackle.
