...
description: "Announcing DataViz Mentor, a GPT-powered tool guide you towards beautiful Data Visualizations for your presentation or articles."
pubDate: "15 Jan 2024"
author: "Gael Grosch"
heroImage:
    url: "/products/dataviz_mentor_overview.png"
    alt: "DataViz Mentor - Enhance your Data Visualizations overview of functionalities"
tags: ["gpt", "dataviz", "data-visualization", "chatgpt", "openai"]
readingTime: 8
---
...
To use DataViz Mentor, visit the [ChatGPT interface](https://chat.openai.com/g/g-rk1495Cu2-dataviz-mentor) and follow these steps:
...
<Image
  src={datavizMentorUI}
  alt="A view of the DataViz Mentor interface using ChatGPT"
/>
...
<Image
  src={theEconomistChart1}
  alt="A chart comparison from The Economist displaying a combination of bar and line chart"
  width="600px"
/>
...
<Image
  src={datavizMentorChart1}
  alt="Recommendations from DataViz Mentor to split the visualization into bar and line chart"
  width="600px"
/>
...
<Image
  src={theEconomistChart2}
  alt="A chart comparison from The Economist displaying 2 lines with different y-axes"
  width="600px"
/>
...
<Image
  src={datavizMentorChart2}
  alt="Recommendations from DataViz Mentor to rework the y-axis"
  width="600px"
/>
